...
def get_market_details(condition_id):
    ...
    try:
        # Fetch from API
        response = make_api_request(f"https://clob.polymarket.com/markets")
        ...
        if market:
            # Update cache
            market_details_cache[cache_key] = market
